...
import 'package:spa_admin_app/screens/add_promo_code.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: ()async{
          ...
          pr.close();
          Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => AddPromoCode(branches)));
      ...
      body: SafeArea(
        child: Column(
          children: [
            CustomAppBarTitleOnly("Promo Codes"),
            Expanded(
                ...
                builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  ...
                  return new ListView(
                    children: snapshot.data!.docs.map((DocumentSnapshot document) {
                      ...
                      CouponModel model= CouponModel.fromMap(data, document.reference.id);
                      return Container(
                        color: Colors.white,
